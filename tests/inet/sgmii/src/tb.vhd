...
begin
  ...
  begin
    ...
    committed_check("Check 1", committed_i_s2.req, committed_i_s2.ack, clock125_s,
  ...
  -- Connect the two SGMII together
  clk_diff_1 <= sgmii_m2p1.clk_m2p_diff;
  sgmii_p2m2.clk_p2m_diff <= clk_diff_1;
  
  data_diff_1 <= sgmii_m2p1.data_m2p_diff;
  sgmii_p2m2.data_p2m_diff <= data_diff_1;
  
  clk_diff_2 <= sgmii_m2p2.clk_m2p_diff;
  sgmii_p2m1.clk_p2m_diff <= clk_diff_2;

  data_diff_2 <= sgmii_m2p2.data_m2p_diff;
