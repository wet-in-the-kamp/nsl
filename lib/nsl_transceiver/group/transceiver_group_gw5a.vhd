...
begin
  ...
  quad: GTR12_QUADB
    port map(
      ...
      FABRIC_CMU0_RESETN_I => reset_n_i,
      FABRIC_CMU0_PD_I => gw_gnd,
      FABRIC_CMU0_IDDQ_I => gw_gnd,
      FABRIC_CMU1_RESETN_I => reset_n_i,
